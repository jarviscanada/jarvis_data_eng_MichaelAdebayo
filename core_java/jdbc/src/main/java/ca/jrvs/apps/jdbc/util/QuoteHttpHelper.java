...
public class QuoteHttpHelper {
  ...
  public Quote fetchQuoteInfo(String symbol) throws IllegalArgumentException, IOException {
    ...
    String url = String.format(
        "https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=%s&apikey=%s&datatype=json",
        symbol, this.apiKey);
    ...
    try (Response response = client.newCall(request).execute()) {
      ...
      System.out.println(
          "API Response: " + jsonResponse); // Debugging line to print the API response
